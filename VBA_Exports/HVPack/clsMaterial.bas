...
On Error GoTo ErrHandler
    ...
    With mySession
        .FindById("wnd[0]/tbar[0]/okcd").Text = "/nmm03" ' Enter the transaction code MM03 in the command field
...
Sub loadClassValues(description As String, specification As String)
    Select Case description
        ...
        Case "HV Material Grade"
            cMatlGrade = specification
    End Select
End Sub
Sub displaySpecs()
...
Public Property Get length() As Single
    length = cLength
End Property
Public Property Get matlGrade() As String
    matlGrade = cMatlGrade
End Property
