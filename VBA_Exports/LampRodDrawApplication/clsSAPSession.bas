...
Public Sub Initialize()
  ...
  Else
    ...
    If MsgBox("Would you like me to attempt to log you on?", vbYesNo) = vbYes Then
        startNetweaver
    Else
...
Public Function ConnectToExistingSession(Optional SessionIndex As Integer = 0) As Boolean
  ...
  Else
    ' No existing session found, start a new one
        If MsgBox("Would you like me to attempt to log you on?", vbYesNo) = vbYes Then startNetweaver
